...
export default function AuthShell({ title, subtitle, children }) {
  return (
    <main className="min-h-screen bg-slate-200 p-4 sm:p-6 dark:bg-black">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden rounded-3xl bg-white shadow-2xl dark:bg-slate-900 lg:grid-cols-2">
        ...
        <section className="relative flex items-center p-6 pt-20 sm:p-10 sm:pt-20">
          {/* Light / dark switch, available before logging in */}
